...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PoFile.translated_words'
        db.add_column('pofile', 'translated_words', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoFile.fuzzy_words'
        db.add_column('pofile', 'fuzzy_words', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PoFile.untranslated_words'
        db.add_column('pofile', 'untranslated_words', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'PoFile.translated_words'
        db.delete_column('pofile', 'translated_words')

        # Deleting field 'PoFile.fuzzy_words'
        db.delete_column('pofile', 'fuzzy_words')

        # Deleting field 'PoFile.untranslated_words'
        db.delete_column('pofile', 'untranslated_words')
